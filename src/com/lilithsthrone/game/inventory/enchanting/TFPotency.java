...
public enum TFPotency {
	...
	MAJOR_DRAIN("Большое уменьшение", PresetColour.GENERIC_TERRIBLE, 8, -3),
	DRAIN("Уменьшение", PresetColour.GENERIC_BAD, 4, -2),
	MINOR_DRAIN("Небольшое уменьшение", PresetColour.GENERIC_MINOR_BAD, 1, -1),
	MINOR_BOOST("Небольшое увеличение", PresetColour.GENERIC_MINOR_GOOD, 1, 1),
	BOOST("Увеличение", PresetColour.GENERIC_GOOD, 4, 2),
	MAJOR_BOOST("Большое увеличение", PresetColour.GENERIC_EXCELLENT, 8, 3);
