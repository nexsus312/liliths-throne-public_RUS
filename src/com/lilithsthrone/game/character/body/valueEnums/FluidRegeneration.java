...
public enum FluidRegeneration {
	...
	/** 0-249 ml/day. */
	ZERO_SLOW("медленно", 0, 250, "медленно", PresetColour.GENERIC_SIZE_ONE),
	
	/** 250-749 ml/day. <b>Median value of 500ml/day is roughly the average for breasts producing milk.</b> */
	ONE_AVERAGE("средне", 250, 750, "", PresetColour.GENERIC_SIZE_TWO),

	/** 750-4999 ml/day. Maximum value is roughly 3.5ml per minute. */
	TWO_FAST("быстро", 750, 5000, "быстро", PresetColour.GENERIC_SIZE_THREE),
	...
	THREE_RAPID("стремительно", 5000, 100_000, "стремительно", PresetColour.GENERIC_SIZE_FOUR),
	
	/** 100,000-500,000 ml/day. Maximum value is roughly 5.8ml per second. */
	FOUR_VERY_RAPID("очень стремительно", 100_000, 500_000, "очень стремительно", PresetColour.GENERIC_SIZE_FIVE);
