...
public enum PenisLength {
	/**Utility*/
	NEGATIVE_UTILITY_VALUE("нет", -1, -1, PresetColour.GENERIC_SIZE_ONE),

	/**Barely even anything there. (0-1 inches)*/
	ZERO_MICROSCOPIC("крохотный", 0, 5, PresetColour.GENERIC_SIZE_TWO),

	/**Average size for a harpy. (2-3 inches)*/
	ONE_TINY("маленький", 5, 10, PresetColour.GENERIC_SIZE_TWO),

	/**Average size for all regular morphs. (4-7 inches)*/
	TWO_AVERAGE("средний", 10, 20, PresetColour.GENERIC_SIZE_THREE),

	/**Average size for a wolf morph. (8-11 inches)*/
	THREE_LARGE("большой", 20, 30, PresetColour.GENERIC_SIZE_FOUR),

	/**Average size for a horse morph. (12-15 inches)*/
	FOUR_HUGE("очень большой", 30, 40, PresetColour.GENERIC_SIZE_FIVE),

	/**Straying into the bounds of "world record for a human". Large for a horse morph. (16-19 inches)*/
	FIVE_ENORMOUS("огромный", 40, 50, PresetColour.GENERIC_SIZE_SIX),
	...
	SEVEN_STALLION("как у коня", 60, 100, PresetColour.GENERIC_SIZE_EIGHT);
