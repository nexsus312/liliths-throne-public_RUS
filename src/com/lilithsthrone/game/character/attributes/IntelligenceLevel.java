...
public enum IntelligenceLevel {
	...
	ZERO_AIRHEAD("магическая импотенция", 0, 10, PresetColour.INTELLIGENCE_STAGE_ZERO) {
		@Override
	...
	ONE_AVERAGE("магический потенциал", 10, 30, PresetColour.INTELLIGENCE_STAGE_ONE) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
	...
	TWO_SMART("квалифицированный маг", 30, 50, PresetColour.INTELLIGENCE_STAGE_TWO) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
	...
	THREE_BRAINY("могущественный маг", 50, 70, PresetColour.INTELLIGENCE_STAGE_THREE) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
	...
	FOUR_GENIUS("мастер магии", 70, 90, PresetColour.INTELLIGENCE_STAGE_FOUR) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
	...
	FIVE_POLYMATH("гений магии", 90, 100, PresetColour.INTELLIGENCE_STAGE_FIVE) {
		@Override
		public AbstractStatusEffect getRelatedStatusEffect() {
