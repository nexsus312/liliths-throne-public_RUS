...
public class CharacterCreation {
		...
		public String getHeaderContent() {
			return "<p>"
					...
					+ "<p>"
						...
						+ " [pc.speech(Нет, нет, нет! Я, наверное, оставил(а) его в такси!)]"
					+ "</p>"
					+ "<p>"
	...
	public static final DialogueNode CHOOSE_ADVANCED_APPEARANCE = new DialogueNode("В музее", "", true) {
		...
		public String getHeaderContent() {
			return "<p>"
					...
					+ "</p>"
					+ "<p>"
						+ "[pc.thought(Фух... Я все-таки успел(а) вовремя...)]"
					+ "</p>"
					+ "<p>"
		...
		public Response getResponse(int responseTab, int index) {
			if (index == 1) {
				...
				return new Response("Вернуться", "Подтвердите свой выбор и вернитесь к настройкам.", CHOOSE_NAME) {
					@Override
					public int getSecondsPassed() {
						return -TIME_TO_APPEARANCE;
					}
	...
	public static String getCheckingClothingDescription() {
		...
		sb.append("<div class='container-full-width' style='background:transparent;'>"
					...
					+ "</p>"
					+ "<p>"
						+ "[pc.thought(Почему я вдруг так возбужден(а)?)]"
					+ "</p>"
					+ "<div class='container-full-width' style='text-align:center;'>"
